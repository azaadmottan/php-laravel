...
<head>
    ...
    <title>Admin Dashboard ({{ Auth::guard('admin')->user()->adminName }})</title>
...
<nav class="navbar navbar-expand-lg bg-dark sticky-top" data-bs-theme="dark">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <div class="btn-group">
            ...
            <li><a class="dropdown-item" href="{{ route('logoutAdmin') }}"><i class="fa-solid me-2 fa-right-from-bracket"></i>Logout</a></li>
            </ul>
        </div>
    </div>
</nav>
